...
# Import trực tiếp từ các module trong cùng thư mục src
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Audio processing pipeline với speaker diarization")
    parser.add_argument("audio_path", type=str, help="Đường dẫn file âm thanh/video")
    parser.add_argument("--num-speakers", type=int, default=None, help="Số người nói chính xác (nếu biết)")
    parser.add_argument("--min-speakers", type=int, default=None, help="Số người nói tối thiểu")
    parser.add_argument("--max-speakers", type=int, default=None, help="Số người nói tối đa")
    parser.add_argument("--chunk-minutes", type=int, default=10, help="Độ dài mỗi chunk (phút)")
